...
class HeaderValuePairTest(unittest.TestCase):
    ...
    def test_float64(self):
        ...
        self.assertEqual(112321312.12312321312312, events[0][3])
    ...
    def test_unint8(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(150, events[0][3])
    ...
    def test_unint16(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(1211, events[0][3])
    ...
    def test_unint32(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(1211123, events[0][3])
    ...
    def test_unint64(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(12121234561111, events[0][3])
    ...
    def test_int8(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(-50, events[0][3])
    ...
    def test_int16(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(-1124, events[0][3])
    ...
    def test_int32(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(-11234213, events[0][3])
    ...
    def test_int64(self):
        ...
        self.assertEqual(EventType.VALUE, events[0][1])
        self.assertEqual([], events[0][0])
        self.assertEqual(-1243546578691, events[0][3])
